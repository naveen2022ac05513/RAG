 ...
 "cells": [
  {
   ...
   "id": "2c98544c-1bf4-431f-91f0-ee821b52e11c",
   "metadata": {},
   "outputs": [],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\USER\\AppData\\Local\\Temp\\ipykernel_3320\\2914618206.py:15: FutureWarning: Setting an item of incompatible dtype is deprecated and will raise an error in a future version of pandas. Value 'None' has dtype incompatible with float64, please explicitly cast to a compatible dtype first.\n",
      "  data.fillna(\"None\", inplace=True)\n",
      "2025-03-01 22:19:22.791 \n",
      "  \u001b[33m\u001b[1mWarning:\u001b[0m to view this Streamlit app on a browser, run it with the following\n",
      "  command:\n",
      "\n",
      "    streamlit run C:\\Users\\USER\\anaconda3\\Lib\\site-packages\\ipykernel_launcher.py [ARGUMENTS]\n",
      "2025-03-01 22:19:22.791 Session state does not function when running a script without `streamlit run`\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "5503642b-26bb-497b-b78b-6065dbf3ed85",
   "metadata": {},
   "outputs": [],
   "source": []
  }
